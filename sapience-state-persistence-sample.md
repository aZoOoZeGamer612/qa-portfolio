...
## Objective
Verify that a villager's contextual state persists correctly through save/reload and does not incorrectly repeat one-time behavior.

## Preconditions
- Test world with Sapience installed.
- A villager has an active contextual interaction/state.
- Save/reload behavior is available.
